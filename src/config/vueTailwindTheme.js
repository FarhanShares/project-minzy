...
export default {
  ...
  "t-button": {
    component: TButton,
    props: {
      fixedClasses: "block px-4 py-2 text-sm transition duration-100 ease-in-out focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed",
      ...
      variants: {
        ...
        warning: "text-gray-700 bg-yellow-300 border border-transparent rounded shadow-sm hover:bg-yellow-200",
